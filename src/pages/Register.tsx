    ...
    >
      ...
      >
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          >
            <motion.button
              whileHover={!isLoading ? { scale: 1.02, boxShadow: '0 0 30px rgba(204,255,0,0.6)' } : {}}
              whileTap={!isLoading ? { scale: 0.98 } : {}}
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center py-4 px-4 border border-transparent text-lg font-black font-display rounded-full text-black bg-[#CCFF00] hover:bg-white transition-all disabled:opacity-70 disabled:cursor-not-allowed uppercase tracking-wider shadow-[0_0_20px_rgba(204,255,0,0.5)]"
            >
              {isLoading ? (
